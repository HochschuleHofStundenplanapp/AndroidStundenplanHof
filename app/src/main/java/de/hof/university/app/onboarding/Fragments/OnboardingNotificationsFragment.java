...
public class OnboardingNotificationsFragment extends Fragment {
    ...
    public void onResume() {
        ...
        mainActivity.getSupportActionBar().setTitle(Html.fromHtml("<font color='"+ ContextCompat.getColor(MainActivity.getAppContext(), R.color.colorBlack)+"'>"+ getString(R.string.onboarding_notifications)+"</font>"));
